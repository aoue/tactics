...
public class Unit : MonoBehaviour
{
    ...
    [SerializeField] private float phys_def;
    [SerializeField] private int magic_atk;
    [SerializeField] private float magic_def;
    ...
    public float get_physd() { return phys_def; }
    public int get_maga() { return magic_atk; }
    public float get_magd() { return magic_def; }
